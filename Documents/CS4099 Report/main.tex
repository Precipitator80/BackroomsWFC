...
\include{Main Sections/03LiteratureReview} % First draft
\include{Main Sections/04RequirementsSpecification} % First draft
\include{Main Sections/05SoftwareEngineeringProcess} % Partial first draft
\include{Main Sections/06Ethics} % First draft
\include{Main Sections/07Design} % Partially written
\include{Main Sections/08Implementation} % Partially written
\include{Main Sections/09Evaluation} % Not written
\include{Main Sections/10Conclusion} % Not written
\printbibliography
%TC:ignore - Starts ignoring word count.
\include{Main Sections/11Appendix}
